...
import { getArticle, getArticles } from "@/lib/mock-api";
        ...
        <div className="container-prose max-w-3xl">
          ...
          <div className="mt-10 space-y-5 text-[17px] leading-[1.8] text-foreground/90">
            ...
            <p className="text-muted-foreground">
              This briefing is condensed from the original source. For complete
              technical detail, methodology, or context, follow the link below.
            </p>
          </div>
